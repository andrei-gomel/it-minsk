                    ...
                    foreach ($albums as $item) {                        
                        ...
                        if($item['file_name'] === NULL)
                        {
                            ...
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                                ...
                                <rect width="100%" height="100%" fill="#55595c" /><text x="50%" y="50%" fill="#eceeef" dy=".3em">Нет фотографий</text>
                            </svg>';
                        }
                        else
                        {
                            echo '<div class="card shadow-sm"><img id="myImg" src="/upload/images/' . $item['file_name'] . '" alt="' . $item['name'] . '"  width="100%" height="225">';
                        }
