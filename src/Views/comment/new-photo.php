                ...
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="card bg-white">
                        <div class="card-body p-5">
                            <div class="mb-3">
                                <h3>Добавление фото в альбом</h3>
                            </div>
                            <?php
                            if ($vars) {
                            ...
                            <form class="mb-3 mt-md-4" action="/image/save" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" name="album_id" id="album_id" class="form-control" placeholder="Введите описание" required value="<?php if (!empty($_SESSION['album_id'])) echo $_SESSION['album_id']; ?>" />
                                </div>


                                <div class="mb-3">
                                    <label class="form-label">Выберите фото</label>
                                    <input type="file" name="photo" id="photo" accept=".png, .jpg, .jpeg, .bmp" class="form-control" placeholder="Введите название" required value="" />
                                </div>
